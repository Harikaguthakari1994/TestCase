	...
	public void setUp() throws Exception {
		...
		//@AfterMethod
			...
			// Logged as admin
				    ...
				    Assignment2POM.Addfeaturelinkclick();
					Assignment2POM.EnterFeatureTextbox("Harika5");
				 Thread.sleep(5000);
					...
					Assignment2POM.Addfeaturebottonclick();
					driver.navigate().refresh();
					//WebElement checkbox =driver.findElement(By.xpath("//label[text()=' Harika4']/preceding-sibling::input[@type='checkbox']"));
					//checkbox.click();
					//String[] holdme = null;
				java.util.List<WebElement> checkbox = driver.findElements(By.xpath("//*[@id='property_feature-436']/ul[1]/li"));
				for(int i =0;i<=checkbox.size();i++){
					System.out.println(checkbox.get(i).getText());
					if(checkbox.contains(" Harika5")){
